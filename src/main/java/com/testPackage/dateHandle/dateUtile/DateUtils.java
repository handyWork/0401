package com.testPackage.dateHandle.dateUtile;
...
//                throw new PlatformException("日期工具类解析【"+date+"】异常!", PlatformExceptionEnum.JE_CORE_UTIL_DATE_ERROR,new Object[]{date,format},e);
    ...
    public static void main(String[] args) throws InterruptedException {
        System.out.println(StringUtil.getSameString("?",1).split("").length);
        String idValues=StringUtil.buildSplitString(StringUtil.getSameString("?",1).split(""),",");
//    	Date now=new Date();
